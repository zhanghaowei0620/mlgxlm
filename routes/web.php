...
Route::get('index_reseller_orderAdd', 'Reseller\ResellerController@index_reseller_orderAdd');   //分校订单-生成

Route::get('index_reseller_Topay', 'Reseller\ResellerController@index_reseller_Topay');   //分校订单-生成
