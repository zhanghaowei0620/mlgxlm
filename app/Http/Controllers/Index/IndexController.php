    ...
    //获取前台分类信息
        public function index(){
            ...
            $goodsInfo = DB::table('mt_goods')
                ...
                ->get(['shop_name','shop_address','shop_score','goods_id','goods_name','price','market_price','introduction','picture'])->toArray();   //店铺精选   默认为1
            ...
            $recommend = DB::table('mt_goods')->where(['is_recommend'=>1])->get(['goods_id','price','picture']);
...
//            ];
            ...
            var_dump(json_encode($response,JSON_UNESCAPED_UNICODE));exit;
